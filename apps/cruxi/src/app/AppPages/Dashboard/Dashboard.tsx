...
const Dashboard = (props: DashboardProps) => {
  ...
  const boulderingProfileSection = (
    <StyledCardStatGroup>
      ...
      <StyledCardStat>{boulderProfile?.defaultGradingSys}</StyledCardStat>
      <StyledH4>Hardest Redpoint</StyledH4>
      <StyledCardStat>{boulderProfile?.hardestRedpoint}</StyledCardStat>
      <StyledH4>Consistent Redpoint</StyledH4>
      <StyledCardStat>{boulderProfile?.consistentRedpoint}</StyledCardStat>
      ...
      <StyledCardStat>{boulderProfile?.consistentOnsight}</StyledCardStat>
      ...
      <StyledCardStat>{boulderProfile?.shortTermProject}</StyledCardStat>
      <StyledH4>Long-Term Project Grade</StyledH4>
      <StyledCardStat>{boulderProfile?.longTermProject}</StyledCardStat>
      <Link to="/profile">
  ...
  const ropeProfileSection = (
    <StyledCardStatGroup>
      ...
      <StyledCardStat>{ropeProfile?.ropeDefaultGradingSys}</StyledCardStat>
      <StyledH4>Consistent Redpoint</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeConsistentRedpoint}</StyledCardStat>
      <StyledH4>Easy Redpoint</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeEasyRedpoint}</StyledCardStat>
      <StyledH4>Hardest Onsight</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeHardestOnsight}</StyledCardStat>
      <StyledH4>Consistent Onsight</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeConsistentOnsight}</StyledCardStat>
      <StyledH4>Easy Onsight</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeEasyOnsight}</StyledCardStat>
      <StyledH4>Short-Term Project Grade</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeShortTermProject}</StyledCardStat>
      <StyledH4>Long-Term Project Grade</StyledH4>
      <StyledCardStat>{ropeProfile?.ropeLongTermProject}</StyledCardStat>
      <Link to="/profile">
        <Button buttonName="Edit Profile" />
      </Link>
    </StyledCardStatGroup>
